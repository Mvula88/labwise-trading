  ...
  "products": [
    {
      ...
      "sourceQuote": "LW/QT/2026/OSH-NSSCAS-STD"
    },
    {
      "sku": "LAB-BIO-002",
      "name": "Dropper pipette (plastic)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-GLA-005",
      "name": "Test tube (heat-resistant, 24×150 mm)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-BIO-009",
      "name": "Test tube rack (wooden, 7-hole)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-BIO-010",
      "name": "Portable Bunsen burner (LPG)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-BIO-011",
      "name": "Tripod stand (steel, 205 mm)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-BIO-012",
      "name": "Gas cartridge (Bunsen refill)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-BIO-013",
      "name": "Gauze wire with ceramic centre",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-BIO-014",
      "name": "Thermometer (mercury 0–100 °C)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-BIO-015",
      "name": "Pre-prepared microscope slide (dicot root)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-BIO-016",
      "name": "Light microscope (monocular LED)",
      "category": "Biology Equipment",
    ...
    {
      "sku": "LAB-CHM-001",
      "name": "Hydrochloric acid 1.0 mol/dm³",
    ...
    {
      "sku": "LAB-CHM-002",
      "name": "Hydrochloric acid 2.0 mol/dm³",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-CHM-003",
      "name": "Sodium hydroxide 0.1 mol/dm³",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-CHM-004",
      "name": "Sodium hydroxide 1.0 mol/dm³",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-CHM-007",
      "name": "Barium nitrate 0.100 mol/dm³",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-CHM-009",
      "name": "Silver nitrate 0.05 mol/dm³",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-CHM-011",
      "name": "Bromothymol blue indicator",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-CHM-013",
      "name": "Aluminium sulfate (hydrated)",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-CHM-015",
      "name": "Soft gelatine (25 g dessert sheets)",
      "category": "Chemicals & Reagents",
    ...
    {
      "sku": "LAB-IND-001",
      "name": "Red litmus paper (booklet)",
      "category": "Indicators & Test Papers",
    ...
    {
      "sku": "LAB-IND-002",
      "name": "Blue litmus paper (booklet)",
      "category": "Indicators & Test Papers",
    ...
    {
      "sku": "LAB-IND-003",
      "name": "Universal indicator paper (booklet)",
      "category": "Indicators & Test Papers",
    ...
    {
      "sku": "LAB-GLA-009",
      "name": "Glass pipette (25 cm³ graduated)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-GLA-010",
      "name": "Pipette filler (rubber 3-valve)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-CHM-EQP-002",
      "name": "Burette clamp (2-burette metallic)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-GLA-013",
      "name": "Volumetric flask with stopper (250 cm³)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-GLA-014",
      "name": "Conical flask (250 cm³ graduated)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-CHM-EQP-003",
      "name": "Stop clock (with second display)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-CHM-EQP-004",
      "name": "Electronic balance (0.01 g, 200 g max)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-GLA-018",
      "name": "Dropper pipette (lab grade)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-GLA-019",
      "name": "Test tube holder (wooden handle)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-GLA-020",
      "name": "Chemical containers (200 ml)",
      "category": "Chemistry Glassware",
    ...
    {
      "sku": "LAB-PHY-001",
      "name": "Retort stand (physics, 60 cm)",
    ...
    {
      "sku": "LAB-PHY-004",
      "name": "Newton meter (spring scale)",
      "category": "Physics Equipment",
    ...
    {
      "sku": "LAB-CON-001",
      "name": "White vinegar (5% food-grade)",
      ...
      "sourceQuote": "LW/QT/2026/OSH-EXTRAS"
    },
    {
      "sku": "LAB-CON-002",
      "name": "Aluminium foil (household roll)",
      "category": "Lab Consumables",
    ...
    {
      "sku": "LAB-CON-005",
      "name": "Cotton wool balls (absorbent)",
      "category": "Lab Consumables",
    ...
    {
      "sku": "LAB-ELE-001",
      "name": "Digital and Linear IC Tester",
      ...
      "sourceQuote": "LW/QT/2026/NUST-ELECLAB"
    },
    {
      "sku": "LAB-ELE-002",
      "name": "Soldering & Desoldering Station (hot air rework)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-003",
      "name": "Spectrum Analyser (9 kHz – 1.5 GHz)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-004",
      "name": "PCB Making Machine (CNC prototyping)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-005",
      "name": "Digital Oscilloscope (200 MHz, 2-channel)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-006",
      "name": "Bench Digital Multimeter (5.5-digit, hFE)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-007",
      "name": "Signal Generator (200 MHz, 2-channel)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-008",
      "name": "DC Power Supply (Triple Output, Programmable)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-009",
      "name": "AC Variable Power Supply (Variac)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-011",
      "name": "Optical Fibre Communication Trainer",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-012",
      "name": "Mobile Communication Trainer",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-013",
      "name": "Satellite Communication Trainer",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-ELE-014",
      "name": "Cathode Ray Oscilloscope (Analog, 20 MHz)",
      "category": "Electronics & Test Equipment",
    ...
    {
      "sku": "LAB-SPE-001",
      "name": "Bertin AlphaE Radon Monitor",
      "category": "Specialised Instruments",
